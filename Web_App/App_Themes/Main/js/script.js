	...
	(function() {
		...
		function scrollPage() {
			...
			if ( sy >= changeHeaderOn ) {
				$('.top-bar').slideUp(300);
				$('.stikynav').slideUp(300);
				$("header").addClass("fixed-header");
				$('.navbar-brand').css({ 'padding-top' : 5 + "px", 'padding-bottom' : 2 + "px" });
				...
				if (/iPhone|iPod|BlackBerry/i.test(navigator.userAgent) || $(window).width() < 479 ){
					...
					$('.navbar-default .navbar-nav > li > a').css({ 'padding-top' : 5 + "px", 'padding-bottom' : 2 + "px" })
